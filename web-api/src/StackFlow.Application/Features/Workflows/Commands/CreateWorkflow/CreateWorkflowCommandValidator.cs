// CreateWorkflowCommandValidator — validates all fields of CreateWorkflowCommand.
// Runs in the ValidationBehavior pipeline step before the handler is called.
// Invalid requests never reach the handler.
//
// Task validation uses RuleForEach to validate each task in the Tasks collection.
// NodeType and AssigneeType are validated as valid enum values using IsInEnum().
